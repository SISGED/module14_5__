...
crud_func.initiate_db()
if crud_func.products_is_empty():
    crud_func.populate_products()
products = crud_func.get_all_products()
...
async def set_username(message, state):
    if crud_func.is_included(message.text):
